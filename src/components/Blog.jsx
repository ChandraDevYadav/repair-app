...
const Blog = () => {
  return (
    <div className='mb-[12rem]'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-8 mx-5 md:mx-40 gap-6'>
        <div className='col-span-1 md:col-span-2 shadow-lg border rounded-lg p-5'>
        ...
        <div className='col-span-1 md:col-span-4'>
          <div className="relative group">
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-4 md:p-12 mt-40">
              <div className='flex gap-10 items-center '>
