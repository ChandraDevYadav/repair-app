...
const Footer = () => {
  return (
    <div className="">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-[#00172d] py-7">
        ...
        <div className="flex justify-center items-center">
          <div className="justify-center text-center">
            ...
            <p className="font-medium text-orange-500">Repair Service</p>
          </div>
        </div>
        <div className="flex justify-center items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-5 bg-[#010f34] px-5 sm:px-20 py-16">
        <div className="flex justify-center items-center">
          <div>
            ...
            <li className="text-white font-medium mb-3 mt-5">Rapid Cool Installation</li>
            <li className="text-white font-medium mb-3">Air Flow Optimization</li>
            <li className="text-white font-medium mb-3">Rapid Drain Unclogging</li>
            <li className="text-white font-medium mb-3">Frost Guard Emergency</li>
            <li className="text-white font-medium mb-3">Breeze Balance Calibration</li>
          </div>
        </div>
        <div className="flex justify-center items-center">
          <div>
            <h1 className="text-2xl text-white font-bold mb-4">Working Hours:</h1>
            <div className="flex gap-1">
              <div className="bg-orange-500 w-[80px] h-1"></div>
              <div className="bg-white w-[20px] h-1"></div>
              <div className="bg-white w-[5px] h-1 rounded-full"></div>
            ...
            <div className="flex flex-col mt-5">
              <li className="text-white font-medium mb-3 flex justify-between">
                Thu - Fri <p>09:00 AM - 7:00 PM</p>
              </li>
              <li className="text-white font-medium mb-3 flex justify-between">
                Mon - Tues <p>08:00 AM - 10:00 PM</p>
              </li>
              <li className="text-white font-medium mb-3 flex justify-between">
                Wed <p>10:00 AM - 11:00 PM</p>
              </li>
              <li className="text-white font-medium mb-3 flex justify-between">
