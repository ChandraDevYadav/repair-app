    ...
    <div className="grid grid-cols-1 md:grid-cols-2 px-6 md:px-24 py-8">
      ...
      <div className="flex flex-col justify-center">
        <div className="mx-4 md:mx-10 mt-8 md:mt-20">
          ...
          <h1 className="text-2xl md:text-5xl font-bold my-4 leading-normal text-[#010f34]">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 text-base md:text-xl mt-5 font-semibold text-gray-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mx-4 md:mx-10 mt-8 md:mt-14 items-center">
          ...
          <div className="flex gap-3 md:gap-5 items-center mt-6 md:mt-0">
