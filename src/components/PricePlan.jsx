...
const PricePlan = () => {
  // Define the plans for monthly and yearly
  const monthlyPlans = [
    {
      name: 'Basic Plan',
      image: './plan11.png',
    ...
    <div className="mt-8 md:mt-12 mb-10">
      ...
      <div className="flex justify-end">
        <Tabs defaultValue="monthly" className="w-full">
          <TabsList className="flex justify-start ml-0 md:ml-12 w-1/2">
                ...
                <div key={index} className="flex justify-center shadow-lg border mx-4 md:mx-0 py-10">
                  <div className="relative">
                    <div className="flex items-center gap-3 my-4">
                      <img src={plan.image} alt={plan.name} className="w-24 h-20"/>
                      <p className="text-xl font-bold underline">{plan.name}</p>
                    </div>
