      ...
      <div className="grid grid-cols-6 gap-5 mx-40">
        <div className="col-span-4">
          <div className="mt-10 shadow-lg pb-6 mb-5">
            <img src="./pro-7.jpg" alt="" className="rounded-xl w-full h-[23rem] transform transition ease-in duration-500 hover:scale-95" />
            ...
            <Button className='border bg-transparent text-black mt-5'>READ MORE</Button>
          </div>
          </div>
          <div className="mt-10 shadow-lg pb-6 mb-5">
            <img src="./pro-8.jpg" alt="" className="rounded-xl w-full h-[23rem] transform transition ease-in duration-500 hover:scale-95" />
            <div className="flex gap-4 items-center p-7">
              <div className="flex justify-center items-center gap-3 border-r pr-5">
                <img src="./people.png" alt="" className="w-4 h-4" />
                <p className="text-gray-500">Post Admin</p>
          ...
          <div className="mt-10 shadow-lg pb-6 mb-5">
            <img src="./pro-9.jpg" alt="" className="rounded-xl w-full h-[23rem] transform transition ease-in duration-500 hover:scale-95" />
            <div className="flex gap-4 items-center p-7">
              <div className="flex justify-center items-center gap-3 border-r pr-5">
                <img src="./people.png" alt="" className="w-4 h-4" />
                <p className="text-gray-500">Post Admin</p>
        ...
        <div className="col-span-2">
          ...
          <div className="bg-[#ff550008] p-8 rounded-xl border mt-10 pb-10">
            ...
            <div className="flex gap-4 mt-5">
                <div>
                    <img src="./pro-1.jpg" className="w-[5rem] h-[5rem] rounded-lg" alt="" />
                </div>
                <div>
                    <p className="text-md font-bold">Keeping You Cool and Comfortable</p>
            ...
            <div className="flex gap-4 mt-5">
                <div>
                    <img src="./pro-2.jpg" className="w-[5rem] h-[5rem] rounded-lg" alt="" />
                </div>
                <div>
                    <p className="text-md font-bold">Keeping You Cool and Comfortable</p>
                    <div className="flex items-center gap-3">
            ...
            <div className="flex gap-4 mt-5">
                <div>
                    <img src="./pro-3.jpg" className="w-[5rem] h-[5rem] rounded-lg" alt="" />
                </div>
                <div>
                    <p className="text-md font-bold">Keeping You Cool and Comfortable</p>
                    <div className="flex items-center gap-3">
          ...
          <div className="bg-[#ff550008] p-8 rounded-xl border mt-10 pb-10">
            ...
            <div className="grid grid-cols-3 gap-5 mt-8">
                <Button className='bg-gray-200 text-sm text-gray-500'>Application</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Art</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Marketing</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Repair</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Installations</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Testing</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Ventilation</Button>
                <Button className='bg-gray-200 text-sm text-gray-500'>Residential</Button>
            </div>
          </div>
        </div>
      </div>
