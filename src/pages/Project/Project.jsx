...
const Project = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-center items-center my-12 mx-4 sm:mx-12 lg:mx-24">
        {projectData.map((project, index) => (
          <div key={index} className="flex justify-center items-center">
            <div className="relative w-full h-80 md:h-96 border rounded-lg overflow-hidden shadow-lg">
              {/* Image */}
              <img
                src={project.image}
                alt={project.name}
              ...
              <div className="absolute inset-0 bg-orange-600 rounded-lg bg-opacity-80 opacity-0 hover:opacity-100 flex flex-col justify-center items-center text-white transition-opacity duration-300 p-4">
                <h3 className="text-lg font-semibold">{project.name}</h3>
                <p className="text-center text-sm">{project.description}</p>
                <div className="flex justify-center items-center mt-4">
                  <Button className="bg-white text-black hover:bg-black hover:text-white rounded-tr-full rounded-br-full">
