...
const Contact = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mx-4 md:mx-40">
        <div className="col-span-1 md:col-span-3">
          <div className="px-4 md:px-12 mt-12">
            <p className="text-3xl md:text-4xl font-bold">Contact Information</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              {[
                ...
                },
                {
                  icon: "./phone-call.png",
                  title: "Phone Number",
                  description: "(+163)-5565-0697 (+578) 587 89168",
                },
                {
                  icon: "./envelope.png",
                  title: "Email Address",
                  description: "info@gmail.com demo@gmail.com",
                },
                {
                  icon: "./clock1.png",
                  title: "Working Time",
                  description: "Work Time: Sun - Fri 10AM - 6PM",
                },
              ].map(({ icon, title, description }) => (
                <div key={title} className="flex gap-4 border px-2 py-2 shadow-lg">
                  <div className="bg-gray-200 flex justify-center items-center px-3 rounded-lg">
                    <img src={icon} alt={title} className="w-8 md:w-12 h-8 md:h-12" />
                  </div>
                  <div>
            ...
            <div className="mt-14">
              ...
              <div className="flex gap-3 mt-5">
                {[
                  ...
                  <div key={index} className="bg-gray-300 p-2 rounded-lg hover:bg-orange-500 hover:text-white">
                    <Icon className="w-5" />
                  </div>
                ))}
              </div>
        ...
        <div className="col-span-1 md:col-span-2">
          <div className="shadow-lg mt-14 border rounded-md px-4 md:px-7 py-10 mb-10">
            <p className="text-center text-3xl font-bold mb-8">Book An Appointment</p>
            <div className="px-3">
              <Input
                type="text"
              ...
              <Input
                ...
                className="bg-gray-200 mt-4 w-full"
              />
              <Input
                type="text"
                placeholder="Select Subjects"
                className="mt-4 bg-gray-200 w-full"
              />
              <Textarea
                placeholder="Write Message..."
                className="bg-gray-200 mt-4 h-[10rem] w-full"
              />
